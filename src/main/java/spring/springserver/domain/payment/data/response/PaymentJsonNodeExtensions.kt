...
internal fun JsonNode.textOrNull(
    fieldName: String
): String? {
...
internal fun JsonNode.longOrNull(
    fieldName: String
): Long? {
...
internal fun JsonNode.intOrNull(
    fieldName: String
): Int? {
...
internal fun JsonNode.booleanOrNull(
    fieldName: String
): Boolean? {
...
internal fun <T> JsonNode.objectOrNull(
    fieldName: String,
    mapper: (JsonNode) -> T
): T? {
...
internal fun <T> JsonNode.listOrNull(
    fieldName: String,
    mapper: (JsonNode) -> T
): List<T>? {
