...
interface CommunityCommentLikeRepository : JpaRepository<CommunityCommentLike, Long> {
    ...
    fun existsByMemberAndCommunityComment(
        member: Member,
        communityComment: CommunityComment
    ): Boolean

    fun countByCommunityCommentId(
        communityCommentId: Long
    ): Long

    fun deleteByMemberAndCommunityComment(
        member: Member,
        communityComment: CommunityComment
    ): Long

    fun deleteAllByCommunityCommentIn(
        communityComments: Collection<CommunityComment>
    )
}
