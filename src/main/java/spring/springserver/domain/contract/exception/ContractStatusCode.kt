...
enum class ContractStatusCode(
    ...
    CONTRACT_INVALID_PERIOD("CONTRACT_INVALID_PERIOD", "용역 종료 시각은 시작 시각보다 빠를 수 없습니다.", HttpStatus.BAD_REQUEST),
    CONTRACT_INVALID_FILE("CONTRACT_INVALID_FILE", "계약서는 PDF 파일만 등록할 수 있습니다.", HttpStatus.BAD_REQUEST),
    CONTRACT_INVALID_POST("CONTRACT_INVALID_POST", "의뢰인(갑)이 작성한 게시글에만 계약을 연결할 수 있습니다.", HttpStatus.BAD_REQUEST);
