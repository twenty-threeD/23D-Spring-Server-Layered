...
enum class ContractStatusCode(
    ...
    CONTRACT_INVALID_MEMBER("CONTRACT_INVALID_MEMBER", "갑과 을은 서로 달라야 합니다.", HttpStatus.BAD_REQUEST),
    CONTRACT_ALREADY_SIGNED("CONTRACT_ALREADY_SIGNED", "서명이 시작된 계약서는 수정하거나 삭제할 수 없습니다.", HttpStatus.CONFLICT),
    CONTRACT_ALREADY_SIGNED_BY_MEMBER("CONTRACT_ALREADY_SIGNED_BY_MEMBER", "이미 서명한 계약서입니다.", HttpStatus.CONFLICT),
