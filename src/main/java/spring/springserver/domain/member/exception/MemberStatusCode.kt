...
enum class MemberStatusCode(
    ...
    PASSWORD_ALREADY_SET("PASSWORD_ALREADY_SET", "이미 비밀번호가 설정되어 있습니다.", HttpStatus.BAD_REQUEST),
    LOCATION_NOT_SET("LOCATION_NOT_SET", "설정된 지역이 없습니다.", HttpStatus.NOT_FOUND);
